...
from src.data.depend_model import DependModel, DependTargetModel
from src.gui.depend.bot.bot_group import BotGroupWidget
...
class BotWidget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.group_widget = BotGroupWidget(self._data_change)  # 帶入資料監聽器，有資料異動呼叫
        ...
        self.target_widget = BotTargetWidget(self._data_change)  # 帶入資料監聽器，有資料異動呼叫
